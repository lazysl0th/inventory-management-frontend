...
const InventoryForm = lazy(() =>
    import('@/widgets/InventoryForm').then((module) => ({
        default: module.InventoryForm,
    }))
)
const ItemList = lazy(() =>
    import('@/widgets/ItemList').then((module) => ({
        default: module.ItemList,
    }))
)
const DiscussionTab = lazy(() =>
    import('@/widgets/DiscussionTab').then((module) => ({
        default: module.DiscussionTab,
    }))
)
const StatsTab = lazy(() =>
    import('@/widgets/StatsTab').then((module) => ({
