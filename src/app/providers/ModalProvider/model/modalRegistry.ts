...
const SupportRequestForm = lazy(() =>
    import('@/widgets/SupportRequestForm').then((module) => ({
        default: module.SupportRequestForm,
    }))
)
const AdditionalInfoForm = lazy(() =>
    import('@/widgets/AdditionalInfoForm').then((module) => ({
        default: module.AdditionalInfoForm,
    }))
)
const VersionConflictDialog = lazy(() =>
    import('@/widgets/VersionConflictDialog').then((module) => ({
        default: module.VersionConflictDialog,
    }))
)
