...
const OAuthSuccessPage = lazy(() =>
    import('@/pages/OAuthSuccessPage').then((module) => ({
        default: module.OAuthSuccessPage,
    }))
)
const DeleteUserDataPage = lazy(() =>
    import('@/pages/DeleteUserDataPage').then((module) => ({
        default: module.DeleteUserDataPage,
    }))
)
...
const InventoryTabsPage = lazy(() =>
    import('@/pages/InventoryTabsPage').then((module) => ({
        default: module.InventoryTabsPage,
    }))
)
const ItemPage = lazy(() =>
    import('@/pages/ItemPage').then((module) => ({ default: module.ItemPage }))
)
const InventoryModalPage = lazy(() =>
    import('@/pages/InventoryModalPage').then((module) => ({
        default: module.InventoryModalPage,
    }))
)
const ItemModalPage = lazy(() =>
    import('@/pages/ItemModalPage').then((module) => ({
        default: module.ItemModalPage,
    }))
)
            ...
            {backgroundLocation && (
                <Routes>
                    <Route
                        ...
                        element={
                            <Suspense
                                fallback={<Loader className='min-vh-100' />}
                            >
                                <InventoryModalPage />
                            </Suspense>
                        }
